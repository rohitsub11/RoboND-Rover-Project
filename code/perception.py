...
def rocks(img, levels=(110, 110, 50)):
...
def perception_step(Rover):
    ...
    # get back ones everywhere thresholded map was 0 and multiply by mask.
    ...
    if rock.any():
        ...
        rock_xcentre = rock_x_world[rock_index]
        rock_ycentre = rock_y_world[rock_index]
 
        Rover.worldmap[rock_ycentre, rock_xcentre, 1] = 255
